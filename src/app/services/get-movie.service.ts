...
export class GetMovieService {
  ...
  formAPIString(request:any){
    try{
      ...
      // if (request.type === 'trending') return `/api/trending?primary_release_date.gte=${date}&api_key=1bcb0de5947ee4ccfdd236151dc0f99d&sort_by=popularity.desc&page=${request.pageNo}`;
