...
export class GetMovieService {
  ...
  formAPIString(request:any){
    try{
      ...
      if (request.type === 'trending') return `https://api.themoviedb.org/3/discover/movie?primary_release_date.gte=2018-9-30&api_key=1bcb0de5947ee4ccfdd236151dc0f99d&sort_by=popularity.desc&page=${request.pageNo}`;
